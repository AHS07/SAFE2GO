"""Edge schema: outbox for edge-to-cloud messages, inbox for applied cloud messages."""
...
class EdgeInbox(Base):
    """Idempotency keys of cloud messages already applied on the edge."""
